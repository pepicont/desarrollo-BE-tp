...
async function main() {
  ...
  u1.urlFoto = 'https://res.cloudinary.com/dbrfi383s/image/upload/usuario/avatar_1.jpg'
  usuarios.push(u1)
  ...
  u.urlFoto = 'https://res.cloudinary.com/dbrfi383s/image/upload/usuario/avatar_1.jpg'
  usuarios.push(u)
    userCount++
  }
  ...
  admin.urlFoto = 'https://res.cloudinary.com/dbrfi383s/image/upload/usuario/avatar_1.jpg'
