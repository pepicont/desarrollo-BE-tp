 ...
 */
checkoutRouter.post('/start', authenticateCliente, startSession);
/**
 * @swagger
 ...
 */
checkoutRouter.post('/simulate-success', authenticateCliente, simulateSuccess);
/**
 * @swagger
 * /api/checkout/status:
 *   get:
 ...
 *         description: Error del servidor
 */
checkoutRouter.get('/status', authenticateCliente, getStatus);
// Mercado Pago
/**
 * @swagger
 ...
 */
checkoutRouter.post('/mp/start', authenticateCliente, startMpPreference);
/**
 * @swagger
 ...
 */
checkoutRouter.get('/mp/confirm', authenticateCliente, confirmMpPayment);
